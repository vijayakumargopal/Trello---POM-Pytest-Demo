...
class TestBoardPage:
    ...
    def test_verify_board_page(self):
        """
        To Run this test: pytest -k test_verify_board_page
        Requirement Covered:
            JIRA-3035
        """
        ...
        board_page.add_card_in_to_do_section("Test Card1")
        board_page.add_card_in_doing_section("Test Card2")
        board_page.add_card_in_done_section("Test Card3")
        board_page.drag_card_drop_card("Test Card1", "To Do", "Doing")
